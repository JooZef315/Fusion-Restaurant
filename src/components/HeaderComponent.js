  ...
  render() {
    return(
      <React.Fragment>
        <Navbar dark expand="md">
          <div className="container">
            ...
            <NavbarBrand className="mr-auto" href="/Fusion-Restaurant"><img src='https://raw.githubusercontent.com/JooZef315/Fusion-Restaurant/gh-pages/assets/images/logo.png' height="30" width="41" alt='Ristorante Con Fusion' /></NavbarBrand>
            <Collapse isOpen={this.state.isNavOpen} navbar>
              <Nav navbar>
                <NavItem>
                  <NavLink className="nav-link text-warning"  to='/Fusion-Restaurant'><span className="fa fa-home fa-lg"></span> Home</NavLink>
                </NavItem>
                <NavItem>
      ...
      /*<Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
        <ModalHeader className="mod" toggle={this.toggleModal} >Login</ModalHeader>
        <ModalBody>
